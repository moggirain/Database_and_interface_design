		...
		<h1>Strain</h1>
			...
			?>
				<table class="table table-responsive">
					<tr>
						<th>Strain_name</th>
						<th>Strain_location</th>
						<th>Strain_manager</th>
					<tr>
			<?php 			
			...
			?>
				<tr>
					...
					<td><?php echo $row['Strain_location']?></td>
					<td><?php echo $row['Strain_manager']?></td>
				</tr>
