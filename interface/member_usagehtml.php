	...
	<div id="fh5co-page">
		...
		<div id="fh5co-main">
			...
			<div class="fh5co-narrow-content animate-box" data-animate-effect="fadeInLeft">				
				...
				<form action="history_member.php" method="post">
					<div class="row">
						<div class="col-md-12">
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<input type="number" class="form-control" placeholder="Member_id" name="Member_id" min=1 required>
									</div>
								</div>
			...
			<div class="row">
				<div class="col-md-4">
					<h1>How many current cages totally?</h1>
				</div>
			</div>
				<form action="history_total.php" method="post">
					<div class="row">
						<div class="col-md-12">
							<div class="row">
								<div class="col-md-6">								
