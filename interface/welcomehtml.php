...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<title>Welcome to Laboratory Mouse Colony Management Database </title>
	...
	<div id="fh5co-page">
		...
		<aside id="fh5co-aside" role="complementary" class="border js-fullheight">
			...
			<h1 id="fh5co-logo"><a href="index.html"><img src="images/urlogo.png" alt="Free HTML5 Bootstrap Website Template"></a></h1>
			<nav id="fh5co-main-menu" role="navigation">
				<ul>
					<li>Center for Translational Neuromedicine</a></li>
					<li class="fh5co-active"><a href="welcome.html">Home</a></li>
		...
		<div id="fh5co-main">
			...
			<div class="fh5co-narrow-content">
                <!-- <h2 class="fh5co-heading animate-box" data-animate-effect="fadeInLeft">Show Tables</span></h2> -->
                <h2 class="fh5co-heading animate-box" data-animate-effect="fadeInLeft">Hi <i><?php echo $_SESSION["login_user"]; ?></i></span></h2>
                <h2 class="fh5co-heading animate-box" data-animate-effect="fadeInLeft">Welcome to Center for Translational Neuromedicine</span></h2>
