	...
	<div id="fh5co-page">
		...
		<div id="fh5co-main">
			...
			<div class="fh5co-narrow-content animate-box" data-animate-effect="fadeInLeft">
				...
				<form action="member_update_cage.php" method="post">
					<div class="row">
						<div class="col-md-12">
							<div class="row">
								<div class="col-md-6">
									...
									<div class="form-group">
										<input type="number" class="form-control" placeholder="*Current_amount(0-5)" name="Current_amount" min=0 max=5 required>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										<input type="submit" class="btn btn-primary btn-md" value="Update Current_cages">
									</div>
								</div>
			...
			<div class="fh5co-narrow-content animate-box" data-animate-effect="fadeInLeft">
					...
					<form action="member_update_strain.php" method="post">
						<div class="row">
							<div class="col-md-12">
								<div class="row">
									<div class="col-md-6">
									...
									<div class="col-md-6">
										<div class="form-group">
											<input type="submit" class="btn btn-primary btn-md" value="Update Strain">
										</div>
									</div>
