...
<html>
	...
	<title>	Member_insert_starin</title>
...
$sql_insert = "INSERT INTO Strain (Strain_name,Strain_location,Strain_manager)
		VALUES ('$Strain','$Location','$Manager')";

if ($conn->query($sql_insert) === TRUE) {
    echo "Congratulations! Values are added.";
} else {
