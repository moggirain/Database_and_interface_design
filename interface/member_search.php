		...
		<aside id="fh5co-aside" role="complementary" class="js-fullheight">
			...
			<nav id="fh5co-main-menu" role="navigation">
				<ul>
					...
					<li class="fh5co-active"><a href="member_searchhtml.php">Search</a></li>
...
// Create Query:
#$Age_cal ="SELECT datediff(curdate(),Birth_date) as Age_cal from Current_cages";
$sql_select = "SELECT * FROM Current_cages where Strain_name='$Strain'and Gender='$Gender'";
//$sql_select = "SELECT * FROM Current_cages where Strain_name='C57B6' and Gender='M' and Age_cal=538";
